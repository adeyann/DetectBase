...
**현 develop HEAD**: cmake VERSION = `0.1.23` (작업 E carry). last master tag = `v0.1.18` (2026-05-27, PR #25). 마지막 push commit cmake = `0.1.22` (작업 D — GstRtsp debug metric + GRPC trace DEBUG_MODE wrap).
