...
/************************************************************************************/
void h_list_get_ownership(LINKED_LIST * p_linked_list)
{
...
void h_list_giveup_ownership(LINKED_LIST * p_linked_list)
{
	if (p_linked_list->list_semMutex)
	{
...
/************************************************************************************/
uint32 h_list_get_number_of_nodes(LINKED_LIST * p_linked_list)
{
...
LINKED_NODE * h_list_lookback_start(LINKED_LIST * p_linked_list)
{
	if (p_linked_list == NULL)
	{
		return NULL;
...
LINKED_NODE * h_list_lookback_next(LINKED_LIST * p_linked_list, LINKED_NODE * p_node)
{
	if (p_node == NULL)
	{
		return NULL;
...
void h_list_lookback_end(LINKED_LIST * p_linked_list)
{
	if (p_linked_list == NULL)
	{
		return;
