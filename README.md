...
**Version**: `0.1.9` (cmake `code/CMakeLists.txt`. master tag `v0.1.0`, develop 누적 patch PR #9~#20.)
...
- 시도 코드는 `.deleted_backup/gst_attempt_20260515/` 에 보존, 자료는 [.DOCS/GSTREAMER_DEEP_REVIEW.md](.DOCS/GSTREAMER_DEEP_REVIEW.md), [.DOCS/ONVIF_PAYLOADER_DESIGN.md](.DOCS/ONVIF_PAYLOADER_DESIGN.md) (재작업 시 참고)
