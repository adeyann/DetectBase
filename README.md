...
| 문서 | 내용 |
|---|---|
| **[logs/NEXT_SESSION.md](logs/NEXT_SESSION.md)** | post-v0.1.18 release / cmake 0.1.19 placeholder 진입점 — v0.1.18 = cam_loss root cause fix (TeardownPipeline unref-skip) + master_logs 보관 절차 (5/27) + cmake bump README 동기 절대 규칙 (5/27) |
